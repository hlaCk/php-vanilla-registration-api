...
$fakers = [];
$app->singleton(FakerGenerator::class, function ($app, $parameters) use (&$fakers) {
    $locale = $parameters['locale'] ?? $app['config']->get('app.faker_locale', 'en_US');

    if (! isset($fakers[$locale])) {
...
$app->bind(\Illuminate\Http\Request::class, 'request');
$app->singleton(\Illuminate\Contracts\View\Factory::class,'view');
$app->singleton(\Illuminate\Contracts\Routing\UrlGenerator::class,'url');
